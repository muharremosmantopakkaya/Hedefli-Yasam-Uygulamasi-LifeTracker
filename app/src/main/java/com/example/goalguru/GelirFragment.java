...
public class GelirFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_gelir, container, false);
        ...
        databaseRef = FirebaseDatabase.getInstance().getReference().child("gelirler");
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Map<String, Object> gelirMap = new HashMap<>();
                gelirMap.put("tarih", tarih);
                gelirMap.put("tutar", tutar);
                gelirMap.put("kategori", kategori);
                gelirMap.put("hesap", hesap);
                gelirMap.put("not", not);

                // Verileri Firebase veritabanına kaydedin
                databaseRef.push().setValue(gelirMap);

                // Verilerin başarıyla kaydedildiğini bildiren bir mesaj gösterin veya istediğiniz işlemleri yapın
                Toast.makeText(getActivity(), "Gelir başarıyla kaydedildi!", Toast.LENGTH_SHORT).show();
